...
class FuseBlock(nn.Module):
    ...
    def forward(self, modality1, modality2, cross_modality=None):
        ...
        if cross_modality is None:
            new_cross_modality = self.update_cross_modality_block(modality1_m, modality2_m)
        else:
            cross_modality_m = self.cross_modality_msc(cross_modality)
            new_cross_modality = self.update_cross_modality_block(modality1_m, 
                                                                  modality2_m, 
                                                                  cross_modality_m)
...
'''
'''
class SSUCC_net_CloudFree(nn.Module):
    def __init__(self, encoder_name, encoder_weights, classes):
        super(SSUCC_net_CloudFree, self).__init__()
    ...
    def forward(self, modality1, modality2, output_shape=None):
        ...
        return cross_modality_pred, feats
...
if __name__ == '__main__':
    ...
    net = SSUCC_net_CloudFree(encoder_name='mit_b4', encoder_weights='imagenet', classes=7)
    net.to(device)
    net.eval()
