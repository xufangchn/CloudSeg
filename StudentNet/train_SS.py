...
if __name__ == "__main__":
    ...
    parser.add_argument('--input_data_folder', type=str, default='/remote-home/xufang/data/RS/M3M-CR/train')
    ...
    parser.add_argument('--save_model_dir', type=str, default='../checkpoints/StudentNet/')
